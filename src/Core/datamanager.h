...
struct DataManager
{
    ...
    static int setPipeValue(int index, int param, double v, Network* nw);
    static int setTimeParam(int param, int value, Network* nw);
    static int getTimeParam(int param, int value, Network* nw);
